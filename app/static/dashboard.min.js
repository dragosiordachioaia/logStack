...
var _jsCookie = __webpack_require__(31);
...
function showApp() {
  var appContainer = _react2.default.createElement(_app2.default, null);
  _reactDom2.default.render(appContainer, document.getElementsByTagName("main")[0]);
}
...
var _reactDropdown = __webpack_require__(36);
...
var _issue_list = __webpack_require__(61);

var _issue_list2 = _interopRequireDefault(_issue_list);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.displayProjectPicker = _this.displayProjectPicker.bind(_this);
    _this.onChangeProject = _this.onChangeProject.bind(_this);
    return _this;
  }
  ...
  App.prototype.componentDidMount = function componentDidMount() {
    ...
    api.fetchProjects().then(function (response) {
      var dropdownOptions = response.data.map(function (project) {
        return {
          value: project._id,
          label: project.name
        };
      ...
      var newErrors = JSON.parse(JSON.stringify(_this2.state.errors));
  ...
  App.prototype.onChangeProject = function onChangeProject(selectedProject) {
    var _this3 = this;

    this.setState({ selectedProject: selectedProject });
    api.fetchGroups(selectedProject.value).then(function (response) {
      _this3.setState({ issues: response.data }, function () {
        console.log(_this3.state);
      });
    }, function (error) {
      var newErrors = JSON.parse(JSON.stringify(_this3.state.errors));
      newErrors.push(error);
      _this3.setState({
        errors: newErrors
      });
  ...
  App.prototype.displayProjectPicker = function displayProjectPicker() {
    if (!this.state.projectOptionsForDropdown) {
      return null;
    }

    return _react2.default.createElement(_reactDropdown2.default, {
  ...
  App.prototype.render = function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_issue_list2.default, { issues: this.state.issues })
    );
  };
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../autoprefixer-loader/index.js!../less-loader/dist/cjs.js!./style.css", function() {
			var newContent = require("!!../css-loader/index.js!../autoprefixer-loader/index.js!../less-loader/dist/cjs.js!./style.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
function fetchGroups(projectID) {
  return _axios2.default.get(BASE_URL + "/projects/" + projectID + "/groups/");
}

function fetchProjects() {
  return _axios2.default.get(BASE_URL + "/projects/");
}
...
var IssueList = function (_Component) {
  ...
  IssueList.prototype.render = function render() {
    ...
    if (this.props.issues.length === 0) {
      return _react2.default.createElement(
        "p",
        null,
        "There are no issues for this projectw"
      );
    }
    ...
    var issues = this.props.issues.map(function (issue, index) {
      return _react2.default.createElement(
        "li",
        { key: issue._id, style: styleElement },
        _react2.default.createElement(
          "span",
          { style: styleMessage },
          issue.message,
