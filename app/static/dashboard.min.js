...
var _issue_list = __webpack_require__(57);
...
var App = function (_Component) {
  ...
  App.prototype.componentDidMount = function componentDidMount() {
    ...
    api.fetchGroups().then(function (response) {
      _this2.setState({ issues: response.data }, function () {
  ...
  App.prototype.render = function render() {
    return _react2.default.createElement(_issue_list2.default, { issues: this.state.issues });
  };
...
function fetchGroups() {
  return _axios2.default.get(BASE_URL + "/groups/");
}
